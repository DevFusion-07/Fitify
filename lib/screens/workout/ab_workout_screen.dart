...
class AbWorkoutScreen extends StatefulWidget {
  const AbWorkoutScreen({super.key});

  @override
  State<AbWorkoutScreen> createState() => _AbWorkoutScreenState();
}

class _AbWorkoutScreenState extends State<AbWorkoutScreen> {
  final ScrollController _scrollController = ScrollController();
  double _headerHeight = 200;
  final double _minHeaderHeight = 80;
  final double _maxHeaderHeight = 200;
  bool _isFavorite = false;
  final String _scheduledTime = "Today, 06:30 AM";
  String _selectedDifficulty = "Beginner";

  final List<ExerciseData> _exercises = [
    ExerciseData("Plank", "00:45", "assets/images/exercises/plank.png")
    ...
    ExerciseData("Crunches", "00:40", "assets/images/exercises/crunches.png")
      ..difficulty = "Beginner"
      ..caloriesPerSet =
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "Core Focus | 8 Exercises | 22mins | 220 Calories Burn",
                                                  style: GoogleFonts.poppins(
                                                    fontSize:
                                                        _headerHeight * 0.035,
            ...
            child: InkWell(
              ...
              onTap: () {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Starting Ab Workout!'),
